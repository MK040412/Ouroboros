...
class TrainingConfig256:
    ...
    # 모델 (XUT-Large with Gemma3-270M embeddings)
    ...
    # Wandb
    wandb_project: str = "xut-large-256"
    ...
    checkpoint_gcs_prefix: str = "checkpoints/xut-large-256"  # gs://bucket/prefix/run_YYYYMMDD_HHMMSS/
